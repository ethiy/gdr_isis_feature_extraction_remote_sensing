...
\begin{document}
  \begin{tikzpicture}
    ...
    \path[mindmap, concept color=black!50, text=black]
      ...
      \path (1.east) + (1.5, 0) node[text=black, align=left] {Unqualifiable |\\Qualifiable\\\textit{finesse:} $0$};
      ...
      \path (2.east) + (1.5, 0) node[text=black, align=left] {Valid | Error\\\textit{finesse:} $1$};

      \path (input.west) + (-7, -.4) node[circle, fill, color=purple, minimum size=1.6cm, anchor=east] (3) {};
      \path (3.east) + (1.5, 0) node[text=black, align=left] {Error Family\\\textit{finesse: }$2$};

      \path (input.west) + (-7, -2.3) node[circle, fill, color=blue!70!yellow, minimum size=1.4cm, anchor=east] (4) {};
      \path (4.east) + (1.5, 0) node[text=black, align=left] {Sub Errors\\\textit{finesse:} $3$};
