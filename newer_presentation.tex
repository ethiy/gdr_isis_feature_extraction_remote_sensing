    ...
    \section{Introduction}
        \subsection{Context}
                    ...
                    \begin{table}
                        \begin{center}
                            \begin{tabular}{c c c}
                                ...
                                & 3D model & 3D mesh\\
                                \midrule
                                Compacity & \textcolor{IGNDarkGreen}{+} & \textcolor{red}{-} \\
                                Fidelity & \textcolor{red}{-} & \textcolor{IGNDarkGreen}{+} \\
                                Semantics & \textcolor{IGNDarkGreen}{+} & \textcolor{red}{-} \\
                                \bottomrule
                            \end{tabular}
                        \end{center}
                    \end{table}
            ...
            \begin{frame}{Level of Detail}
                ...
                \end{figure}
                \only<2-4>{
                    The model \acrfull{acr::lod} depends on:
                    \begin{itemize}[label=--]
                        \item<3-> the intended use,
                        \item<4-> the input data spatial resolution.
                    \end{itemize}
                }
            \end{frame}
